...
match('Ha$!a$@!^rijE', 'ḥa̱̖ȧ̱̤̖rıjẹ')

match('Ha$!a$@_^rijE', 'ḥa̱̖ā̤̖̇rıjẹ')

match('H!u&_^th~', 'ḥ̖ṵ̄̇tḩ')
match('eT!e_^mu', 'eṭ̖ē̇mu')
match('txya@+a-a++u', 'txyà̤áȁu')
match('hwpo$kUimUno$s', 'hwpo̖kụımụno̖s')
...
match('p*at@', 'ṗ̂aṱ')
match('t*et.', 'ṭ̬et̰')
match('n~ul~t~', 'n̂ul̬t̬')
match('b?ad?', 'ɓaɗ')
match('p*od*h~t*ak*el*', 'ṗ̂oḍ̬ḩṭ̬aḳ̬eḷ̬')
